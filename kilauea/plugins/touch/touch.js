Kilauea.addPlugin('http://sharpeleven.net/kilauea/touch', 'touch', function(inst, params) {
	/**
	 * Class: http://sharpeleven.net/kilauea/touch
	 *
	 * Provides support for devices with touch screens (mostly mobile ones such as iPhone / iPad), e.g. for using touch gestures such as swipe
	 *
	 * Parameters:
	 *   touch doesn't need any parameters so far.
	 */
	this.revision = "$Id:$";
	this.id = inst.id;
...
Kilauea.plugins['http://sharpeleven.net/kilauea/touch'].prototype = {
